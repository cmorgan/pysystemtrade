...
class ForecastCombineFixed(SystemStage):
    ...
    def get_all_forecasts(self, instrument_code, rule_variation_list=None):
        ...
        """
        def _get_all_forecasts(system, instrument_code,
                               this_stage, rule_variation_list):

            if rule_variation_list is None:
                rule_variation_list = this_stage.get_trading_rule_list(
                    instrument_code)
    ...
    def get_raw_forecast_weights(self, instrument_code):
        ...
        def _get_raw_forecast_weights(system, instrument_code, this_stage):
            ...
            forecasts_ts = this_stage.get_all_forecasts(
...
class ForecastCombineEstimated(ForecastCombineFixed):
    ...
    def __init__(self):
        ...
        protected = [
            'get_forecast_correlation_matrices',
        ...
        def _get_forecast_correlation_matrices(system, NotUsed1, NotUsed2, this_stage,
            ...
            forecast_data = [
                this_stage.get_all_forecasts(
                    instr_code,
                    this_stage.apply_cost_weighting(instr_code)) for instr_code in codes_to_use]
    ...
    def get_forecast_diversification_multiplier(self, instrument_code):
        ...
        def _get_forecast_div_multiplier(system, instrument_code, this_stage):
            ...
            correlation_list_object = this_stage.get_forecast_correlation_matrices(
                instrument_code)
    ...
    def apply_cost_weighting(self, instrument_code):
        ...
        def _apply_cost_weighting(
                system, instrument_code, this_stage, ceiling_cost_SR):
    ...
    def get_raw_forecast_weights(self, instrument_code):
        ...
        def _get_raw_forecast_weights(system, instrument_code, this_stage):
            ...
            return this_stage.calculation_of_raw_forecast_weights(
